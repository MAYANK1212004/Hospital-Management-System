...
public class AdminDashboardModernUI extends JFrame {
    ...
    public AdminDashboardModernUI() {
        ...
        lblDoctorCount = createGlassCard("👨‍⚕️ Doctors", "Loading...", new Color(27, 156, 252));
        lblPatientCount = createGlassCard("🧑‍⚕️ Patients", "Loading...", new Color(72, 195, 163));
        lblMedicalRecordCount = createGlassCard("📋 Medical Records", "Loading...", new Color(255, 185, 60));
        lblAppointmentCount = createGlassCard("📅 Appointments", "Loading...", new Color(239, 83, 80));
