...
public class StockAlertPanel extends JFrame {
    ...
    private void loadLowStockMedicines() {
        ...
        try {
            String sql = "SELECT name, quantity FROM medicines WHERE quantity <= 10 ORDER BY quantity ASC";
            ...
            while (rs.next()) {
                ...
                sb.append("- ").append(medName).append(": ").append(qty).append("\n");
            }
            ...
            alertArea.setText("Error loading stock data.");
            e.printStackTrace();
        }
    }
